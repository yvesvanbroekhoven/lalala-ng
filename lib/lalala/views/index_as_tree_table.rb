module ActiveAdmin
  module Views
    ...
    #     end
    #
    class IndexAsTreeTable < ActiveAdmin::Component
      ...
      def build(page_presenter, collection)
        ...
        tree_table_for collection, table_options do |t|
          table_config_block = page_presenter.block || default_tree_table
          instance_exec(t, &table_config_block)
        end
      end

      def tree_table_for(*args, &block)
        insert_tag IndexTreeTableFor, *args, &block
      end

      def default_tree_table
        proc do
          selectable_column
          id_column
      ...
      #
      class IndexTreeTableFor < ::ActiveAdmin::Views::TreeTableFor
